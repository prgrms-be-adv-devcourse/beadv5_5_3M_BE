...
public enum ErrorStatus implements BaseErrorCode {
    ...
    // Movie
    MOVIE_REGISTRATION_LIMIT_EXCEEDED(HttpStatus.BAD_REQUEST, "MOVIE400", "영화는 최대 3개까지 등록할 수 있습니다"),
    MOVIE_NOT_FOUND(HttpStatus.NOT_FOUND, "MOVIE404", "영화를 찾을 수 없습니다"),
    MOVIE_INVALID_CREATOR(HttpStatus.FORBIDDEN, "MOVIE403", "해당 영화에 대한 권한이 없습니다"),
