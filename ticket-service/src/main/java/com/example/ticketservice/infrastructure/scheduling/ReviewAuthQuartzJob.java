...
public class ReviewAuthQuartzJob extends QuartzJobBean {
    ...
    private ReviewAuthUseCase reviewAuthUseCase;

    public void setReviewAuthUseCase(ReviewAuthUseCase reviewAuthUseCase) {
        this.reviewAuthUseCase = reviewAuthUseCase;
    }
